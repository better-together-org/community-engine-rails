...
export DB_PORT="${DB_PORT:-5440}"
export DB_USERNAME="${DB_USERNAME:-postgres}"
export DB_PASSWORD="${DB_PASSWORD:-postgres}"
export ES_HOST="${ES_HOST:-http://host.docker.internal:9200}"
export ELASTICSEARCH_URL="${ELASTICSEARCH_URL:-http://host.docker.internal:9200}"
export REDIS_URL="${REDIS_URL:-redis://host.docker.internal:6380}"
export RACK_ATTACK_REDIS_URL="${RACK_ATTACK_REDIS_URL:-redis://host.docker.internal:6381}"
