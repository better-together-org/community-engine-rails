import { a as isSymbol, b as baseFlatten, c as baseClone, d as baseIteratee, k as keys, e as baseFindIndex, f as baseEach, g as arrayMap, h as castFunction, j as baseForOwn, l as hasPath, m as castPath, t as toKey, n as baseGet, o as hasIn, p as toString, q as forEach, G as Graph, i as isUndefined, r as filter, v as values, s as reduce } from "./graph-00ca1ddf.js";
import { a8 as isObject, a9 as setToString, aa as overRest, ab as root, ac as baseRest, ad as isIterateeCall, ae as keysIn, af as eq, ag as isArrayLike, ah as isArray, ai as baseFor, aj as baseAssignValue, ak as identity, al as isIndex, am as assignValue, an as baseUnary, ao as constant, ap as merge } from "./mermaid-d73f18bb.js";
var reWhitespace = /\s/;
...
function runLayout(g, time2) {
  ...
  time2("    acyclic", () => run$2(g));
  time2("    nestingGraph.run", () => run(g));
  ...
  time2("    normalize.undo", () => undo(g));
  time2("    fixupEdgeLabelCoords", () => fixupEdgeLabelCoords(g));
  time2("    undoCoordinateSystem", () => undo$1(g));
