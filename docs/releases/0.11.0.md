...
- current release packet can rely on docs + diagrams here
- do not force a screenshot deliverable until a completed person-facing federation consent UI exists on branch tip
