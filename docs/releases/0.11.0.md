...
=======
- JSON:API endpoints and MCP tooling for content blocks and page blocks, plus broader page/post search and editing primitives
- `SearchPagesTool` and a shared AREL content-search helper for page-oriented MCP discovery (`#1273`)
- adapterized block contracts and error reporting for content/editor flows (`#1490`)
>>>>>>> c86321be5 (docs(release): refresh 0.11.0 notes and artefacts)
