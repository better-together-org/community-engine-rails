...
4. **Implemented but intentionally gated or deferred work:** E2EE rollout, AI/robot runtime foundations, and hidden block families that are present in code but not part of the normal organizer rollout path.
