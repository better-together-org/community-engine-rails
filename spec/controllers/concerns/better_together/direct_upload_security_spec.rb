...
module BetterTogether
  ...
  # :no_auth (checked first, highest priority in AutomaticTestConfiguration) plus
  # :skip_host_setup together fully opt this file out of the global auto-auth/host-setup
  # hooks. Without :no_auth specifically, the description-text heuristic matches "signed
  # in" (present in this file's own context descriptions, describing the state under test,
  # not requesting real login) and tries to Devise-sign-in a real user against this
  # minimal, non-routing controller stub, which has no Devise/Warden test-helper wiring.
