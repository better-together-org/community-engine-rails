...
module BetterTogether
  RSpec.describe "/geography/region_settlements", type: :request do
    ...
    # Geography::RegionSettlement. As you add validations to Geography::RegionSettlement, be sure to
    ...
    describe "GET /index" do
      it "renders a successful response" do
        Geography::RegionSettlement.create! valid_attributes
    ...
    describe "GET /show" do
      it "renders a successful response" do
        region_settlement = Geography::RegionSettlement.create! valid_attributes
    ...
    describe "POST /create" do
      context "with valid parameters" do
        it "creates a new Geography::RegionSettlement" do
          expect {
      ...
      context "with invalid parameters" do
        it "does not create a new Geography::RegionSettlement" do
          expect {
