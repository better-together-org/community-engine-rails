...
module BetterTogether
  RSpec.describe "/geography/continents", type: :request do
    ...
    # Geography::Continent. As you add validations to Geography::Continent, be sure to
    ...
    describe "GET /index" do
      it "renders a successful response" do
        Geography::Continent.create! valid_attributes
    ...
    describe "GET /show" do
      it "renders a successful response" do
        continent = Geography::Continent.create! valid_attributes
    ...
    describe "GET /new" do
      it "renders a successful response" do
        get new_geography_continent_url
        expect(response).to be_successful
      end
    end
    ...
    describe "POST /create" do
      context "with valid parameters" do
        it "creates a new Geography::Continent" do
          expect {
            post geography_continents_url, params: { geography_continent: valid_attributes }
          }.to change(Geography::Continent, :count).by(1)
        end
      ...
      context "with invalid parameters" do
        it "does not create a new Geography::Continent" do
          expect {
            post geography_continents_url, params: { geography_continent: invalid_attributes }
          }.to change(Geography::Continent, :count).by(0)
        end
