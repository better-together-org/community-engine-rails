  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new BetterTogether::PersonPlatformIntegration" do
        ...
        }.to change(BetterTogether::PersonPlatformIntegration, :count).by(1)
      end
    ...
    context "with invalid parameters" do
      it "does not create a new BetterTogether::PersonPlatformIntegration" do
        ...
        }.to change(BetterTogether::PersonPlatformIntegration, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        authorization = BetterTogether::PersonPlatformIntegration.create! valid_attributes
        patch person_platform_integration_url(authorization), params: { person_platform_integration: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
