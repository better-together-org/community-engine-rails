...
RSpec.describe 'BetterTogether::Metrics::LinkClickReportsController download', :as_platform_manager do
  ...
  it 'downloads an attached report file' do # rubocop:todo RSpec/MultipleExpectations
    ...
    report = BetterTogether::Metrics::LinkClickReport.create!(file_format: 'csv', platform: host_platform)
  ...
  it 'does not download a report from another platform' do
    report = BetterTogether::Metrics::LinkClickReport.create!(file_format: 'csv', platform: create(:better_together_platform))
