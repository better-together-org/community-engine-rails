...
RSpec.describe 'API V1 - People', :skip_host_setup do
  ...
  path '/api/v1/people' do
    get 'List all people' do
      ...
      description 'Retrieve a list of people. Unauthenticated users only see public profiles. ' \
                  'Authenticated users see public profiles and their own profile.'
  ...
  path '/api/v1/people/{id}' do
    ...
    get 'Get a specific person' do
      tags 'People'
      produces 'application/vnd.api+json'
      description 'Retrieve a specific person by ID. Public profiles are accessible to all. ' \
