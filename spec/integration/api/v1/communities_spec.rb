...
RSpec.describe 'API V1 - Communities', :skip_host_setup do
  ...
  path '/api/v1/communities' do
    get 'List all communities' do
      ...
      description 'Retrieve a list of communities. Unauthenticated users only see public communities. ' \
                  'Authenticated users see public communities and communities they have access to.'
  ...
  path '/api/v1/communities/{id}' do
    ...
    get 'Get a specific community' do
      tags 'Communities'
      produces 'application/vnd.api+json'
      description 'Retrieve a specific community by ID. Public communities are accessible to all. ' \
