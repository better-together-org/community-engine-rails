...
RSpec.describe 'better_together/shared/_claims_and_evidence' do
  it 'renders claims and their supporting evidence links' do
    ...
    claim = create(:better_together_claim, claimable: post, claim_key: 'safety_claim',
                                           statement: 'Safety guidance should remain evidence-backed.')
