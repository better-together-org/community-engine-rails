...
unless FactoryBot.factories.registered?(:'better_together/community_invitation')
  FactoryBot.define do
    factory 'better_together/community_invitation',
            class: 'BetterTogether::CommunityInvitation',
            aliases: %i[better_together_community_invitation community_invitation] do
      ...
      trait :with_facilitator_role do
        role { BetterTogether::Role.find_by(identifier: 'community_organizer') || BetterTogether::Role.find_by(identifier: 'community_facilitator') }
      end
    end
  end
end
