...
RSpec.describe BetterTogether::InvitationPolicy, :as_platform_manager do # rubocop:todo RSpec/MultipleDescribes
  ...
  describe '#resend? when user is present and has permission' do
  ...
  describe '#resend? when user is not present' do
    let(:user) { nil }
...
describe '#create?' do # rubocop:todo RSpec/DescribeClass
...
describe '#destroy? when user is present and has permission' do # rubocop:todo RSpec/DescribeClass
  context 'with pending invitation' do
    let(:invitation) { create(:better_together_invitation, invitable: community, status: 'pending') }
...
describe '#destroy? when user is not present' do # rubocop:todo RSpec/DescribeClass
  let(:user) { nil }
