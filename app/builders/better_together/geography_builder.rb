    ...
    class << self
      ...
      def countries
        [
          ...
          { name: 'Central African Republic', description: 'Country in Africa', iso_code: 'CF', continents: ['Africa'] },
          ...
          { name: 'Democratic Republic of the Congo', description: 'Country in Africa', iso_code: 'CD', continents: ['Africa'] },
          { name: 'Djibouti', description: 'Country in Africa', iso_code: 'DJ', continents: ['Africa'] },
          { name: 'Egypt', description: 'Country in both Africa and Asia', iso_code: 'EG', continents: ['Africa', 'Asia'] },
          ...
          { name: 'Armenia', description: 'Country in Asia', iso_code: 'AM', continents: ['Asia', 'Europe'] },
          { name: 'Azerbaijan', description: 'Country in Asia', iso_code: 'AZ', continents: ['Asia', 'Europe'] },
          ...
          { name: 'Cyprus', description: 'Country in Asia', iso_code: 'CY', continents: ['Asia', 'Europe'] },
          { name: 'Georgia', description: 'Country in Asia', iso_code: 'GE', continents: ['Asia', 'Europe'] },
          ...
          { name: 'Kazakhstan', description: 'Country in Asia', iso_code: 'KZ', continents: ['Asia', 'Europe'] },
          ...
          { name: 'Turkey', description: 'Country in both Europe and Asia', iso_code: 'TR', continents: ['Europe', 'Asia'] },
          ...
          { name: 'Russia', description: 'Country in both Europe and Asia', iso_code: 'RU', continents: ['Europe', 'Asia'] },
          ...
          { name: 'Antigua and Barbuda', description: 'Country in North America', iso_code: 'AG', continents: ['North America'] },
          ...
          { name: 'Costa Rica', description: 'Country in North America', iso_code: 'CR', continents: ['North America'] },
          ...
          { name: 'Dominican Republic', description: 'Country in North America', iso_code: 'DO', continents: ['North America'] },
          { name: 'El Salvador', description: 'Country in North America', iso_code: 'SV', continents: ['North America'] },
          ...
          { name: 'Saint Kitts and Nevis', description: 'Country in North America', iso_code: 'KN', continents: ['North America'] },
          { name: 'Saint Lucia', description: 'Country in North America', iso_code: 'LC', continents: ['North America'] },
          { name: 'Saint Vincent and the Grenadines', description: 'Country in North America', iso_code: 'VC', continents: ['North America'] },
          { name: 'Trinidad and Tobago', description: 'Country in North America', iso_code: 'TT', continents: ['North America'] },
          { name: 'United States', description: 'Country in North America', iso_code: 'US', continents: ['North America'] },
