  ...
  module Joatu
    ...
    class PersonAccessGrantRequest < Request
      ...
      def resolve_or_activate_person_link!(grantor_person, grantee_person)
        ...
        connection = request.send(:resolve_platform_connection_for, grantor_person, grantee_person)

        unless grantor_person && grantee_person && connection
