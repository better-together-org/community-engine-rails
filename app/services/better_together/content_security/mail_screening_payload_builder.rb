...
module BetterTogether
  module ContentSecurity
    # Builds shared-contract screening payloads for inbound email bodies and attachments.
    # rubocop:disable Metrics/ClassLength
    class MailScreeningPayloadBuilder
      def initialize(inbound_email:, mail:, resolution:, sender:, body_plain:)
      ...
      attr_reader :inbound_email, :mail, :resolution, :sender, :body_plain
      ...
      def message_payload(message)
        base_payload(
          ...
          object: {
            ...
            size_bytes: mail.encoded.to_s.bytesize,
            storage_backend: 'mail_store',
            primary_digest: digest_for(mail.encoded.to_s)
          },
      ...
      def attachment_object_payload(message, attachment, index, raw_content)
      ...
      def tenant_payload
        return tenant_platform_payload if resolution.platform.present?
