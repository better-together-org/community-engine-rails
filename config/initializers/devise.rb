...
Devise.setup do |config| # rubocop:todo Metrics/BlockLength
  ...
  config.parent_controller = 'BetterTogether::ApplicationController'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = ENV.fetch('FROM_ADDRESS', 'Better Together Community <community@bettertogethersolutions.com>')

  # Configure the class responsible to send e-mails.
  # config.mailer = 'Devise::Mailer'

  # Configure the parent class responsible to send e-mails.
  config.parent_mailer = 'BetterTogether::ApplicationMailer'
  ...
  config.router_name = :better_together
  #
