...
% Auto-generated (support_staff)
% \today

## Overview

This PDF bundles the primary Community Engine documentation for support_staff. Source of truth remains the repository markdown; diagrams should be re-rendered before export.
